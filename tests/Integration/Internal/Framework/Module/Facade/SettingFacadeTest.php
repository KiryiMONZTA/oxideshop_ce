...
use OxidEsales\EshopCommunity\Internal\Framework\Module\Facade\SettingFacadeInterface;
...
final class SettingFacadeTest extends TestCase
{
    use ContainerTrait;

    private string $testModuleId = 'testSettingModuleId';
    private SettingFacadeInterface $settingFacade;


    protected function setUp(): void
    {
        parent::setUp();
        $this->settingFacade = $this->get(SettingFacadeInterface::class);
